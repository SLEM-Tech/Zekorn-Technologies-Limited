...
export const SEODATA: Record<string, SEOConfig> = {
	default: {
		...
		description: `${CompanyShortName} Digital Innovations Ltd provides cutting-edge software development, AI integration, and digital transformation strategies to scale modern enterprises.`,
		keywords: [
			`${CompanyShortName} Digital`,
	...
	register: {
		...
		description: `Create an account to start your project journey with ${CompanyShortName} Digital Innovations and access premium tech resources.`,
		keywords: [
