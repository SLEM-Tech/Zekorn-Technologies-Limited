	...
	return (
		<>
			<div className='flex flex-col w-full max-w-[32rem] pt-8 pb-6 md:pb-10 px-3 md:px-7 sm:shadow-lg sm:rounded-xl'>
				<h4 className='text-xl text-primary-500 font-semibold text-center md:text-2xl uppercase'>
					Login
				</h4>
					...
					<Form className='flex flex-col gap-2 md:gap-4'>
						...
						<div>
							...
							<TextInput
								...
								className={`w-full px-2 py-4 text-base rounded-md border bg-transparent border-secondary-800 outline-none focus:border-transparent transition-[.5] ease-in focus:ring-1 focus:ring-primary-500 ${
						...
						<button
							...
							className={`flex items-center justify-center border relative text-white border-transparent hover:border-primary-500 hover:border-transparent text-base leading-[1.4] font-semibold py-2.5 sm:py-3 w-full rounded-md gap-1.5 transition ${
						...
						<div className='flex justify-center text-sm md:text-base'>
							...
							<span
								...
								className='text-primary-500 font-semibold hover:underline cursor-pointer transition underline-offset-4'
							>
								Sign up
							</span>
						</div>
