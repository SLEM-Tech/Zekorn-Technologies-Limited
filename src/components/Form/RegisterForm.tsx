	...
	return (
		<>
			<div className='flex flex-col w-full max-w-[32rem] py-5 md:pb-10 px-3 md:px-5 sm:shadow-lg sm:rounded-xl'>
				<h4 className='text-xl md:text-2xl uppercase text-primary-400 font-semibold text-center lg:mb-2'>
					Register
				</h4>
					...
					<Form className='flex flex-col gap-2 md:gap-3'>
						<div className='grid lg:grid-cols-2 gap-2 md:gap-3'>
							<div>
								...
								<TextInput
									...
									type='text'
									className={`w-full px-2 py-4 text-base rounded-md border bg-transparent border-secondary-800 outline-none transition-[.5] ease-in focus:border-transparent focus:ring-1 focus:ring-primary-500 ${
							...
							<div>
								...
								<TextInput
									...
									type='text'
									className={`w-full px-2 py-4 text-base bg-transparent rounded-md border border-secondary-800 outline-none transition-[.5] ease-in focus:border-transparent focus:ring-1 focus:ring-primary-500 ${
						...
						<div>
							...
							<TextInput
								...
								className={`w-full px-2 py-4 text-base rounded-md bg-transparent border border-secondary-800 outline-none focus:border-transparent transition-[.5] ease-in focus:ring-1 focus:ring-primary-500 ${
						...
						<button
							type='submit'
							className={`flex items-center justify-center mt-3 border relative text-white border-transparent hover:border-primary-400 hover:border-transparent text-base leading-[1.4] font-semibold py-2.5 sm:py-3 w-full rounded-md gap-1.5 transition ${
						...
						<div className='flex justify-center text-sm md:text-base'>
							...
							<span
								...
								className='text-primary-400 font-semibold hover:underline cursor-pointer transition underline-offset-4'
							>
								Log in
							</span>
						</div>
