						...
						<div className='space-y-2 border-b border-slate-100 pb-6'>
							<div className='flex items-center gap-2'>
								<span
									...
									className='text-[10px] font-black uppercase tracking-[2px] text-primary-500'
								/>
						...
						<div className='py-8 space-y-6'>
							<div className='flex flex-wrap items-center gap-6'>
								<div className='flex flex-col gap-2'>
									...
									<div className='flex items-center bg-slate-100 rounded-2xl p-1 border border-slate-200'>
										...
										<button
											onClick={increase}
											className='size-10 flex items-center justify-center bg-primary-500 text-white rounded-xl shadow-md hover:opacity-90 transition-all active:scale-90'
										>
											<AiOutlinePlus />
										</button>
									</div>
								...
								<div className='flex-1 min-w-[200px] pt-6'>
									<button
										...
										className='w-full bg-slate-900 text-white py-4 rounded-2xl font-black uppercase text-xs tracking-widest hover:bg-primary-500 transition-all shadow-xl shadow-slate-200 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed'
									>
							...
							<div className='grid grid-cols-2 gap-4 py-6 border-t border-slate-100'>
								...
								<div className='flex flex-col items-center text-center gap-2 border-x border-slate-100'>
									<FiTruck className='text-primary-500 text-xl' />
									<span className='text-[9px] font-bold uppercase text-slate-500'>
										Fast Shipping
									</span>
								</div>
