				...
				<div className='flex flex-col w-full max-w-6xl mx-auto pb-10 px-0'>
					...
					{isTrulyLoading ? (
											...
											{currentTableData.map((order: any, i: number) => (
												...
												>
													...
													<td className='px-6 py-4 text-center'>
														<Link
															href={`/order/${order.id}`}
															className='inline-flex items-center px-5 py-2.5 bg-slate-900 text-white text-[10px] font-black uppercase tracking-[1px] rounded-full hover:bg-primary-500 transition-colors'
														>
															Details
														</Link>
													</td>
						...
						<div className='bg-white rounded-[2rem] border border-gray-100 py-32 text-center shadow-xl'>
							...
							<Link
								href='/'
								className='bg-primary-500 text-white px-10 py-4 rounded-2xl text-xs font-black uppercase tracking-widest shadow-xl shadow-primary-500/30'
							>
								Go to Store
							</Link>
						</div>
