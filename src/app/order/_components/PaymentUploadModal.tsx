								...
								<div className='bg-slate-900 rounded-[1.2rem] p-6 text-white mb-8 shadow-xl shadow-slate-200 relative overflow-hidden'>
									...
									<div className='relative z-10 space-y-5'>
										<div className='flex justify-between items-start'>
											<span className='text-[9px] bg-primary-500 px-2 py-0.5 rounded text-white uppercase font-black tracking-widest'>
												Official Account
											</span>
											{isBankLoading ? (
								...
								<div className='space-y-6'>
									...
									<div>
										<label className='text-[10px] font-black text-slate-400 uppercase flex items-center gap-1 mb-2 tracking-widest'>
											<FiUploadCloud className='text-primary-500' /> Proof of
											Payment
										</label>
										<div
											className={`relative border-2 border-dashed rounded-[2rem] p-4 transition-all cursor-pointer 
        ${fileError ? "border-red-500 bg-red-50/30" : file ? "border-green-500 bg-green-50/30" : "border-slate-200 bg-slate-50/50 hover:border-primary-500"}`}
											onClick={() =>
												!file &&
									...
									<button
										...
										className='w-full py-5 bg-primary-500 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-primary-500/30 disabled:opacity-50 transition-all flex justify-center items-center hover:translate-y-[-2px] active:scale-[0.98]'
									>
										{isLoading ? (
